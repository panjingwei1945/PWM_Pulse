...
- [ ] Confirm the release version `0.4.2` and library name `PWM_Pulse`.
...
3. Commit the complete release files, then create and push the agreed version tag, `v0.4.2`. The tagged files must contain the matching metadata version.
